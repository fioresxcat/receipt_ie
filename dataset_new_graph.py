...
class NewGraphDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        self.train_ds = NewGraphDataset(general_cfg=self.config, mode='train')
        self.val_ds = NewGraphDataset(general_cfg=self.config, mode='val')
...
if __name__ == '__main__':
    ...
    data_module = NewGraphDataModule(config=general_config)
    pdb.set_trace()

    train_ds = NewGraphDataset(general_cfg=general_config, mode='train')
