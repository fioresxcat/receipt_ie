...
import yaml
from model import *
# from dataset import GraphDataModule
from dataset_new_graph import NewGraphDataModule
# from dataset_add_visual import VisualGraphDataModule
# from dataset_new_graph_bert_emb import NewGraphBertEmbDataModule
...
# from infer_add_visual import inference
# from infer_new_graph_bert_emb import inference
from infer_new_graph import inference
...
def train(general_cfg, model_cfg):
    ...
    # get data
    data_module = NewGraphDataModule(config=general_cfg)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_des', type=str, required=True)
    ...
    general_cfg['options']['model_type'] = model_type
    general_cfg['training']['exp_description'] = args.exp_des
